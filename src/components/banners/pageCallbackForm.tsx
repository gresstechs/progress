...
const PageCallbackForm = () => {
   ...
   // width:200px;
    ...
    return (
        ...
        <>
        <StyledButton  sx={{ backgroundColor: "#00A7E5", borderRadius: "10px 10px", right: { sm: '0%', xs: '4%' }, color: '#ED3237', maxWidth:"230px" }} onClick={handleOpen}>Request A Callback<NavigateNextIcon /></StyledButton><Modal open={open}
            onClose={handleClose}
